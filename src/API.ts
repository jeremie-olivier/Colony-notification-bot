...
export type ModelDiscordChannelConditionInput = {
  discordServer?: ModelIDInput | null,
...
export type SearchableColonyFilterInput = {
  ...
  and?: Array< SearchableColonyFilterInput | null > | null,
  or?: Array< SearchableColonyFilterInput | null > | null,
  not?: SearchableColonyFilterInput | null,
};
...
export type SearchableColonySortInput = {
  field?: SearchableColonySortableFields | null,
  direction?: SearchableSortDirection | null,
};

export enum SearchableColonySortableFields {
  id = "id",
  name = "name",
  url = "url",
  createdAt = "createdAt",
...
export type SearchableColonyAggregationInput = {
  name: string,
  type: SearchableAggregateType,
  field: SearchableColonyAggregateField,
};
...
export enum SearchableColonyAggregateField {
  id = "id",
  name = "name",
  url = "url",
  createdAt = "createdAt",
...
export type SearchableColonyConnection = {
  __typename: "SearchableColonyConnection",
  items:  Array<Colony | null >,
  nextToken?: string | null,
  total?: number | null,
...
export type ModelSubscriptionDiscordChannelFilterInput = {
  ...
  discordServer?: ModelSubscriptionIDInput | null,
...
export type DiscordChannelsByDiscordServerQueryVariables = {
  discordServer: string,
...
export type DiscordChannelsByDiscordServerQuery = {
...
export type SearchColoniesQueryVariables = {
  filter?: SearchableColonyFilterInput | null,
  sort?: Array< SearchableColonySortInput | null > | null,
  limit?: number | null,
  nextToken?: string | null,
  from?: number | null,
  aggregates?: Array< SearchableColonyAggregationInput | null > | null,
};

export type SearchColoniesQuery = {
  searchColonies?:  {
    __typename: "SearchableColonyConnection",
    items:  Array< {
      __typename: "Colony",
...
export type MentionsByUserQueryVariables = {
  user: string,
  sortDirection?: ModelSortDirection | null,
  filter?: ModelMentionFilterInput | null,
  limit?: number | null,
...
export type MentionsByUserQuery = {
  mentionsByUser?:  {
    __typename: "ModelMentionConnection",
    items:  Array< {
      __typename: "Mention",
...
export type NotificationSubscriptionsByAuthorQueryVariables = {
  author: string,
  sortDirection?: ModelSortDirection | null,
  filter?: ModelNotificationSubscriptionFilterInput | null,
  limit?: number | null,
...
export type NotificationSubscriptionsByAuthorQuery = {
